...
//             "developer" => Ok(RoleManagement::Develper),
...
//             RoleManagement::Develper => "Developer",
//         }
//     }
// }
...
//     // Add a new user
//     pub fn add_user(&mut self, username: String, password: String,role:RoleManagement) -> io::Result<()> {
//         let encryptor = Encryptor::new(ENCRYPT_KEY,IV_PATTERN);
//         let hashed_password = encryptor.encrypt(&password);
//         let user = User { username: username.clone(), password: hashed_password ,role:role.as_str()};
...
//         let _ = self.add_user("admin".to_string(), "123456".to_string());
//         let encryptor = Encryptor::new(ENCRYPT_KEY, IV_PATTERN);
        
//         // Ensure the users HashMap is initialized
...
//             self.add_user("admin".to_string(), "123456".to_string());
//         }
